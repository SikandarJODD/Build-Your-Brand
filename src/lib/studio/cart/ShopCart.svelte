<script lang="ts">
  ...
  import { allproducts, cartItems, totalPrice } from "$lib/state";
    ...
    >
        ...
        >
          ...
          {:else}
            <div class="my-10 text-lg">
              Shopping Cart is Empty visit <a
                href="/products"
                class="underline underline-offset-2">Products</a
              > to buy amazing Products
            </div>
          {/each}
        </ul>
      </section>
      ...
      {#if $cartItems.length > 0}
        <section
          ...
          class="mt-16 rounded-lg bg-gray-50 dark:bg-gray-800/30 shadow-lg border border-primary px-4 py-6 sm:p-6 lg:col-span-5 lg:mt-0 lg:p-8"
        >
          <h2 id="summary-heading" class="text-lg font-medium text-primary">
            Order summary
          </h2>

          <dl class="mt-6 space-y-4">
            <div class="flex items-center justify-between">
              <dt class="text-sm text-primary/60">Subtotal</dt>
              <dd class="text-sm font-medium text-primary/80">
                ₹{$totalPrice}.00
              </dd>
            </div>
            <div
            ...
            >
              <dt class="flex items-center text-sm text-primary/60">
              ...
              <dd class="text-sm font-medium text-primary/80">₹500.00</dd>
            </div>
            <div
              class="flex items-center justify-between border-t border-gray-200 pt-4"
            >
              <dt class="flex text-sm text-primary/60">
              ...
              <dd class="text-sm font-medium text-primary/80">₹200</dd>
            </div>
            <div
              class="flex items-center justify-between border-t border-gray-200 pt-4"
            >
              <dt class="text-base font-medium text-primary/90">Order total</dt>
              <dd class="text-base font-medium text-primary/80">
                ₹{$totalPrice + 500 + 200}
              </dd>
            </div>
          </dl>
