...
>
  ...
  <div></div>
  <h1
    class="mt-5 text-center text-4xl font-bold md:text-6xl text-primary md:text-gray-900"
  >
    Build Your Brand
  </h1>
  <h2
    class="text-center text-lg font-thin md:text-2xl text-primary md:text-black"
  >
  ...
  <div class="flex items-center gap-2 flex-wrap mt-3 md:gap-4">
    <Button href="/products" variant="outline">
      <ShoppingBag size={20} strokeWidth={1.5} class="mr-1.5" />
      View Products</Button
    >
    <Button class="border" on:click={sendSeller}>Become a Seller</Button>
  </div>
</div>
